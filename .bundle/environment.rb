...
module Bundler
  ...
  HOME         = '/Users/komagata/Sites/croppi/vendor/bundle/bundler'
  ...
  SPECS        = [
        ...
        {:load_paths=>["/Users/komagata/Sites/croppi/vendor/bundle/gems/rack-1.2.1/lib"], :loaded_from=>"/Users/komagata/Sites/croppi/vendor/bundle/specifications/rack-1.2.1.gemspec", :name=>"rack"},
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/sinatra-1.0/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/sinatra-1.0.gemspec", :name=>"sinatra"},
      ].map do |hash|
